...
if __name__ == "__main__":
    ...
    base_conf = OmegaConf.to_container(OmegaConf.load("configs/pose_sample.yaml"))
    ...
    for ndx in range(len(loader)):
        ...
        base_conf["validation_data"]["video_length"] = pose_seq.shape[0]
        result = main(**OmegaConf.create(base_conf), skeleton_path=pose_seq)
